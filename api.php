...
try {
    ...
    if ($method === 'GET') {
        // Before serving the live queue, pull any Doctor Portal completions so a
        // finished consult shows up in Billing (lets the queue page poll adopt it).
        if ($resource === 'queue' || $resource === 'all') {
